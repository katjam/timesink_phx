...
var _user$project$Main$viewPerson = function (person) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(person.slackid),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
					...
					},
					{
									...
									{ctor: '[]'},
									{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Slack Id'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
						...
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								A2(_elm_lang$core$List$map, _user$project$Main$viewPerson, model.people)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Main$decodeList = _elm_lang$core$Json_Decode$list(_user$project$Main$personDecoder);
...
var _user$project$Main$PersonData = function (a) {
	return {ctor: 'PersonData', _0: a};
};
var _user$project$Main$initialCmd = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$PersonData,
	A2(_elm_lang$http$Http$get, 'http://localhost:4000/api/people', _user$project$Main$decoder));
